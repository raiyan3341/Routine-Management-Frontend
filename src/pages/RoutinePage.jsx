...
const RoutinePage = () => {
    ...
    return (
        <div className="max-h-screen bg-[#0f172a] p-1 md:p-4 text-slate-200 flex flex-col overflow-hidden">
            <h1 className="text-lg md:text-3xl font-extrabold text-center mb-10 mt-10 text-cyan-400 tracking-tighter shrink-0">
                Academic Schedule <span className="text-white opacity-50 font-light md:text-3xl">| Spring 2026</span>
            </h1>

            {/* Table Container - table height is preserved, only the wrapper scrolls */}
            <div className="overflow-auto rounded-lg border border-slate-700 shadow-2xl bg-[#1e293b]">
                                ...
                                {timeSlots.map((_, index) => {
                                    ...
                                    return (
                                        <td key={index} className="p-0.5 md:p-1 relative group border-r border-slate-700/20">
                                            {cell ? (
                                                /* HOBOHU APNAR DEYA DESIGN AND HEIGHT */
            ...
            <p className="text-center text-slate-600 text-[10px] md:text-[10px] py-3 uppercase tracking-widest shrink-0">
