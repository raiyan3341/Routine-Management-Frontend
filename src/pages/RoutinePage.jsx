...
const downloadPDF = () => {
    ...
    doc.setFontSize(9);
    doc.text("CLASS ROUTINE • FALL 2026 • SECTION 9C", 148.5, 19, { align: 'center' });
    ...
    return (
        <div className="min-h-screen bg-[#020617] p-2 md:p-6 text-slate-300 font-sans pb-10">
            ...
            <div className="text-center mb-6 mt-4">
                ...
                <p className="text-[10px] md:text-xs font-bold text-slate-500 uppercase tracking-[0.3em] mt-1">FALL Semester 2026</p>
            </div>
